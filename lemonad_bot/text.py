TEXT = {
    "start": lambda lottery: f"""Хей, привет! 👋
Ты пришёл на главное событие этой весны - Лимонад Пати!🍋 Тебя ждёт много интересных точек, 
море лимонада, веселья и куча классных призов!
...
Веселись! Вот тебе карта активностей 👇""",
    ...
    "infocard" : "Карта поможет тебе сориентироваться на Лимонад Пати ❤️\nЛови👇 ",
    "wheretogo": """Точки в нашем квесте деляться на 2 категории: 
...
""",
    ...
    "star"      : '🥳 Ура! Ты прошёл все особые точки! Теперь ты можешь получить заслуженный приз - лимонад и стикерпак ✨\nПодходи на точку "Раздатка"!',
    "super_star"     : """Молодец! Ты прошёл все точки и набрал максимум баллов! Оставайся с нами и следи за результатами розыгрыша, не забудь номер своего лотерейного билета! 🎰 
Его узнать ты можешь, нажав кнопку "Моя статистика"!""",
    "unexpected": 'Я тебя не понимаю 😢 Воспользуйся кнопкой "Помощь", чтобы узнать, что я могу',
    "help"      : """Я квест-бот Лимонад Пати!
...
""",
    ...
    "lottery" : lambda num, lot: f"""Номер твоего лотерейного билета {lot}, баллы: {num}
...
🔸 Три лучших фотографии нашего фестиваля получат персональный подарок от Дона Лимона. Открывай профиль, делай фото и выкладывай на свою страницу ВК с хэштегом #ЛимонадПати2023""",
    ...
    "programma" : """Чтобы не пропустить всё самое интересное, лови расписание нашего дня: ⏰
...
""",
    ...
    "station":  {
        ...
        "Мяч в клетке"                    : "покажи умения работать в команде и достань мяч!",
        "Дженга"                          : "попробуй сыграть в большую дженгу, будет весело!", 
        "Спорт"                           : "покажи всем свою физическую подготовку!", 
        "Киккер"                          : "сразись в настольный футбол!",
        "Мелки"                           : "вспомни детсво и разукрась весь асфальт мелками!",
        "Лимонад-понг"                    : "такая знакомая игра... Проверь свою точность!",
        "Фотозона"                        : "сделай топовые фото для соцсетей прямо на нашем фестивале и участвуй в конкурсе!",
        "Бисер"                           : "сплети себе брелок с лимоном на память!" ,
        "Тату от STK Tattoo studio"       : "всегда хотелось сделать тату, но было страшно? Попробуй на лимоне!",
        "Виртуальная реальность"          : "хочешь побывать по ту сторону экрана?",
        "Квиз, плиз! от ККО"              : "как хорошо ты помнишь школьную программу?",
        "Электроcхемы"                    : "узнай, как работают электросхемы!", 
        "Диджеинг"                        : "почувствуй себя в роли диджея, тебе понравится! ",
    }
}
